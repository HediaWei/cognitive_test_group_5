 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "    #with details_output:\n",
    "    display(HTML(f\"<span style='color:black; font-size: 20px;'>Unique Anynomous code:</span>\"))\n",
    "    name = input('ID:')\n",
    "    \n",
    "    display(HTML(f\"<span style='color:black; font-size: 20px;'>What is your age?; </span>\"))\n",
    "    age = input('Age:')\n",
    "    \n",
    "    display(HTML(f\"<span style='color:black; font-size: 20px;'>What is your gender?</span>\"))\n",
    "    gender = input('Gender:')\n",
    "    \n",
    "    display(HTML(f\"<span style='color:black; font-size: 20px;'>Do you drink alcohol before test (Y/N)?</span>\"))\n",
    "    alcohol = text_input('Alcohol consumption:')\n",
    "    \n",
    "    display(HTML(f\"<span style='color:black; font-size: 20px;'>Do you/ have you ever smoked (Y/N)?</span>\"))\n",
